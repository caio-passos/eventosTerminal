                    ...
                    case 2:
                        ...
                        switch (valoruser) {
                            case 1:
                                ...
                                System.out.println("Qual o CPF do novo usuário:\n");
                                Scanner cpfInṕut = new Scanner(System.in);
                                String CPF = cpfInṕut.nextLine();

                                System.out.println("Qual o nome do novo usuario?: \n");
                                Scanner nomeInput = new Scanner(System.in);
                                String nomeUsuario = nomeInput.nextLine();

                                System.out.println("Qual o email do novo usuário? \n");
                                Scanner emailInput = new Scanner(System.in);
                                String emailUsuario = emailInput.nextLine();

                                System.out.println("Qual a cidade do novo usuário? \n");
                                Scanner cidadeInput = new Scanner(System.in);
                                String cidadeUsuario = cidadeInput.nextLine();

                                System.out.println("Qual o telefone do novo usuário? \n");
                                Scanner telefoneInput = new Scanner(System.in);
                                String telefoneUsuario = telefoneInput.nextLine();

                                UsuarioData usuarioData = new UsuarioData(idUsuario, CPF, nomeUsuario, emailUsuario, cidadeUsuario, telefoneUsuario);
                            ...
                            case 2:
                                ...
                                usuarioDAO = new UsuarioDAOImpl();
                                List<UsuarioData> allUsersList = usuarioDAO.getAll();
                                for (UsuarioData allUsers : allUsersList) {
                                    System.out.println(allUsers);
                                }

                                System.out.println("\nDigite o nome do usuario a ser removido");
                                Scanner removeUser = new Scanner(System.in);
                                String nomeUsuarioDel = removeUser.nextLine();
                                int usuariosDeletados = usuarioDAO.delete(nomeUsuarioDel);
                                if (usuariosDeletados == 0) {
                                    System.out.println("Nenhum usuario chamado " + nomeUsuarioDel + " encontrado");
                                } else {
                                    System.out.println(nomeUsuarioDel + "foi deletado");
                                }
                                break;
                        }
                    default:
                        System.out.println("\nDeseja continuar no sistema?\n\nEscolha numérica: \n1 (sim) \n||||||\n2 (nao) : \n");
                        Scanner rodandoScanner = new Scanner(System.in);
                        int fechar = rodandoScanner.nextInt();
                        switch (fechar) {
                            case 1:
                                rodando = false;
                                System.out.println("\nFechando o sistema ...");
